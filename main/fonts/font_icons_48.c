 ...
 * Size: 48 px
 * Bpp: 4
 * Opts: --no-compress --no-prefilter --bpp 4 --size 48 --format lvgl --force-fast-kern-format --lv-include lvgl.h -o main/fonts/font_icons_48.c --font managed_components/lvgl__lvgl/scripts/built_in_font/FontAwesome5-Solid+Brands+Regular.woff -r 61452,61453,61553
 ******************************************************************************/
...
#ifndef FONT_ICONS_48
#define FONT_ICONS_48 1
#endif
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 864, .adv_w = 528, .box_w = 33, .box_h = 34, .ofs_x = 0, .ofs_y = 1},
    {.bitmap_index = 1425, .adv_w = 864, .box_w = 56, .box_h = 48, .ofs_x = -1, .ofs_y = -6}
};
...
{
    {
        .range_start = 61452, .range_length = 102, .glyph_id_start = 1,
